...
class KNearestNeighbor(object):
  ...
  def compute_distances_one_loop(self, X):
    ...
    for i in range(num_test):
      ...
      #dists[i,:] = scipy.spatial.distance.cdist(self.X_train,X[i,:].reshape(1, 3072)).T
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in range(num_test):
      ...
      while(another!=k):
        ...
        closest_y.insert(another,self.y_train[index[another]])
        another=another+1
      #########################################################################
      # TODO:                                                                 #
      ...
      # label.                                                                #
      #########################################################################
      #print(self.y_train[291])
      #print(closest_y)
      count=np.zeros(len(closest_y)+1)
      count=np.bincount(closest_y)
      y_pred[i]=int(np.argmax(count))
